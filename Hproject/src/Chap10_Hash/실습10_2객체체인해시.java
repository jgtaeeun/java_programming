		...
		do {
			...
			case Add:
				...
				if (result == 0)
					...
					System.out.printf(" %d 입력 처리됨", result);
				break;
			case Delete:
				// Delete
				data = new SimpleObject5();
				...
				if (result == -1)
					...
					System.out.printf("%d 삭제 처리됨",result);
				break;
			case Search:
				data = new SimpleObject5();
				...
				if (result ==-1)
					...
					System.out.printf("%d  검색 데이터가 존재한다",result);
				break;
			case Show:
				hash.dump();
				break;
